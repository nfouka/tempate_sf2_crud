...
class LoadFixtures implements FixtureInterface, ContainerAwareInterface
{
    ...
    private function loadUsers(ObjectManager $manager)
    {
        ...
        $annaAdmin = new User();
        $annaAdmin->setUsername('nfouka');
        $annaAdmin->setEmail('nfouka@symfony.com');
        $annaAdmin->setRoles(array('ROLE_ADMIN'));
        $encodedPassword = $passwordEncoder->encodePassword($annaAdmin, 'lonelyness');
    ...
    private function loadPosts(ObjectManager $manager)
    {
        foreach (range(1, 10) as $i) {
            ...
            $post->setAuthorEmail('nfouka@symfony.com');
